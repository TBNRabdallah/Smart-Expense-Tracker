...
B. Categorization: Organize expenses into predefined categories (Food, Transport, Entertainment, etc.)

C. Data Validation: Robust input validation and error handling
...
B. Monthly Trend Analysis: Bar charts showing spending patterns over time

C. Comparative Analysis: Side-by-side comparison of different months
...
B. Time-based Filtering: Filter by month and custom periods

C. Financial Summaries: Detailed reports by category and month
...
B. Auto-save Feature: Automatic data persistence

C. Data Recovery: Load existing data on startup
